...
public class CityParksListAdapter extends BaseAdapter {
    ...
    public CityParksListAdapter(Context context, Activity activity , ArrayList<CityListIO> cityArrayList)
    {
    ...
    public View getView(int pos, View convertView, ViewGroup arg2) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.item_city_parks_list, null);
            ...
            ViewGroup.LayoutParams.WRAP_CONTENT, CityFragment.parkLayoutHeight-10);
