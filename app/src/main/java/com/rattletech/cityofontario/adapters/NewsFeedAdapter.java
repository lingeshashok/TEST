...
public class NewsFeedAdapter extends BaseAdapter {
    ...
    private ArrayList<NewsIO> cotactArrayList;

    public NewsFeedAdapter(Context context, ArrayList<NewsIO> cotactArrayList) {
        mInflater = LayoutInflater.from(context);
        this.cotactArrayList = cotactArrayList;
    }
    ...
    public View getView(int pos, View convertView, ViewGroup arg2) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.item_news_feed_list, null);
            holder = new ViewHolder();
            holder.newsFeedLink = (TextView) convertView.findViewById(R.id.text_link);
            holder.newsFeedLink.setPaintFlags(holder.newsFeedLink.getPaintFlags() | Paint.UNDERLINE_TEXT_FLAG);
