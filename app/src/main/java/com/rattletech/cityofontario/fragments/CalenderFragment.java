...
TextView idMonthDisplay;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String[] catogory = getActivity().getResources().getStringArray(R.array.array_category);
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(getActivity(), R.layout.spinner_category,catogory);
